...
const content = {
  ...
  shortcuts: legacy.shortcuts.map((record) => ({ id: record.id, kind: 'shortcut', category: detailText(record.id, 'category', record.category), stages: record.stages, ...titled(record, record.summary), mac: record.mac, win: record.win, menu: { zhHans: record.menuZh, en: record.menuEn }, level: record.level, flags: record.flags })),
